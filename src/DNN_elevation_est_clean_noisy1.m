%% Elevation Estimation DNN Script - Using Distance Estimation Techniques
...
if ~exist('localization_data', 'var')
    ...
    fprintf('Defining elevation network architecture (distance techniques)...\n');
    ...
    layers = [
        ...
        %% 2. Elevation-specific Feature Extraction Layers - Enhanced with distance techniques
        % Layer 1: Capture spectral notches and pinna filtering effects (using distance filter sizes)
        convolution2dLayer([1 64], 128, 'Name', 'elev_conv1', 'Padding', 'same')
        ...
        convolution2dLayer([1 32], 128, 'Name', 'elev_conv2', 'Padding', 'same')
        ...
        convolution2dLayer([1 16], 96, 'Name', 'elev_conv3', 'Padding', 'same')
    ...
    fprintf('Elevation estimation network architecture created (distance techniques).\n');
...
fprintf('Starting elevation estimation training with distance techniques...\n');
...
%% Train Network
fprintf('Starting elevation estimation network training (distance techniques)...\n');
tic;
...
save('elevation_model_distance_techniques.mat', 'trainedNetwork_elevation', 'results');
fprintf('\nTrained elevation estimation model saved to: elevation_model_distance_techniques.mat\n');

%% Display Final Summary
fprintf('\n=================================================\n');
fprintf('ELEVATION ESTIMATION TRAINING COMPLETE (DISTANCE TECHNIQUES)\n');
fprintf('=================================================\n');
...
fprintf('R-squared: %.4f\n', r_squared);
fprintf('Model saved to: elevation_model_distance_techniques.mat\n');
fprintf('=================================================\n');